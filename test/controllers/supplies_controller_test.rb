...
class SuppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post supplies_url, params: { supply: { inventory_id: @supply.inventory_id, supplied_amount: @supply.supplied_amount } }, as: :json
    end
  ...
  test "should update supply" do
    patch supply_url(@supply), params: { supply: { inventory_id: @supply.inventory_id, supplied_amount: @supply.supplied_amount } }, as: :json
    assert_response 200
  end
